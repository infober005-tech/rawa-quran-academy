...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "منصة رواء للحلقات القرآنية الإلكترونية والتصحيح المباشر للتلاوة." },
      { property: "og:type", content: "website" },
      { property: "og:locale", content: "ar_SA" },
      { property: "og:site_name", content: "Rawa Quran Academy" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "رواء — أكاديمية القرآن الكريم" },
      { name: "twitter:description", content: "منصة رواء للحلقات القرآنية الإلكترونية." },
